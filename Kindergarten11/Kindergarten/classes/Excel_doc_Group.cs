...
namespace Kindergarten
{
    ...
    ///
    /// </summary>
    internal class Excel_doc_Group
    {
        ...
        public static void SqlToExcels()
        {
            ...
            try
            {
                ...
                xlSheet.Cells[3, 3] = Doc_group.Group_name;
            ...
            finally
            {
                ...
                xlSheet.SaveAs(path + @"\Список выбранной группы.xlsx");
        ...
        public static bool GetGroup(string Group)
        {
            try
            {
                string sql = "SELECT concat(kid.Name,' ',kid.Surname,' ',kid.Patronymic) AS 'ФИО ребенка' FROM kid,group_kid where kid.Kod_Group = group_kid.Kod_Group AND group_kid.Name = '" + Group + "';";
