...
namespace Kindergarten
{
    partial class Add_lessons
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Add_lessons));
			...
			this.comboBox2.Location = new System.Drawing.Point(31, 140);
			...
			this.comboBox3.Location = new System.Drawing.Point(31, 226);
			...
			this.label4.Text = "Дата проведенного занятия";
			// 
			// dateTimePicker1
			// 
			...
			this.label5.Text = "Проведенные часы";
			// 
			// textBox1
			// 
			...
			this.button3.Location = new System.Drawing.Point(262, 226);
			...
			this.Text = "Добавить";
			this.Load += new System.EventHandler(this.Add_lessons_Load);
