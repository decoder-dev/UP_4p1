...
{
	partial class Data_vaccination
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Data_vaccination));
			...
			this.button4.Location = new System.Drawing.Point(901, 402);
			...
			// Column1
			// 
			this.Column1.DataPropertyName = "Kod_vaccination_data";
			...
			this.Column2.HeaderText = "Вакцинация";
			...
			// Column3
			// 
			this.Column3.DataPropertyName = "Date_of_vaccination";
			this.Column3.HeaderText = "Дата вакцинации";
			this.Column3.Name = "Column3";
			this.Column3.ReadOnly = true;
			// 
			// Column4
			// 
			this.Column4.DataPropertyName = "FIO_kid";
			this.Column4.HeaderText = "ФИО ребенка";
			...
			this.label2.Location = new System.Drawing.Point(791, 148);
			...
			this.comboBox2.Location = new System.Drawing.Point(794, 176);
			...
			this.button5.Location = new System.Drawing.Point(794, 90);
			...
			this.button7.Location = new System.Drawing.Point(901, 354);
			...
			this.label3.Location = new System.Drawing.Point(791, 212);
			this.label3.Name = "label3";
			this.label3.Size = new System.Drawing.Size(64, 16);
			this.label3.TabIndex = 17;
			this.label3.Text = "Вакцина";
			// 
			// comboBox3
			// 
			...
			this.comboBox3.Location = new System.Drawing.Point(794, 243);
			...
			this.Name = "Data_vaccination";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Вакцинация";
			this.Load += new System.EventHandler(this.Data_vaccination_Load);
