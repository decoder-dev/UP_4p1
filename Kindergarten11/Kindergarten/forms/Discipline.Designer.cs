...
namespace Kindergarten
{
    partial class Discipline
    {
        ...
        private void InitializeComponent()
        {
			...
			// Column1
			// 
			this.Column1.DataPropertyName = "Kod_Discipline";
			...
			// Column2
			// 
			this.Column2.DataPropertyName = "Name_dist";
			...
			// Column3
			// 
			this.Column3.DataPropertyName = "Number_of_hours_per_week";
			this.Column3.HeaderText = "Количество часов в неделю";
			...
			this.button3.Location = new System.Drawing.Point(284, 367);
