...
{
    public partial class Add_lessons : Form
    {
        public Add_lessons()
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void Add_lessons_Load(object sender, EventArgs e)
        {
            string group = "SELECT Kod_Group,Name FROM group_kid;";
            string FIO_staff = "SELECT staff.Kod_staff,staff.FIO FROM staff,post where staff.Kod_post = post.Kod_post AND staff.Kod_post NOT IN('4');";
        ...
        /// <summary>
        /// Добавление новой записи в таблицу "Занятия" за недельный период времени (От Пн до Пт)
        ///
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Proverka_hour_lesson.Hour = 0;
            Find_hour_dist_fromlessonsproverka.Hour_dist = 0;

            int i, n;
            //  DateTime[] mass = new DateTime[4];
            //  n = 7;
            ...
            else
            {
                ...
                if ((comboBox1.Text != "") && (comboBox2.Text != "") && (comboBox3.Text != "") && (textBox1.Text != ""))
                {
                    ...
                    else
                    {
                        ...
                        int vcego = Proverka_hour_lesson.Hour + Convert.ToInt32(textBox1.Text);
                        ...
                        else
                        {
                            ...
                            {
                                DBAdd_lessons.Add(comboBox1.SelectedValue.ToString(), comboBox2.SelectedValue.ToString(), comboBox3.SelectedValue.ToString(), date, textBox1.Text);
                                DBGet_lessons.Get();
                                this.Close();
                            }
                        }
