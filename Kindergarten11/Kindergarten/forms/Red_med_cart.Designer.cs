...
namespace Kindergarten
{
	partial class Red_med_cart
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Red_med_cart));
			...
			this.textBox3.Location = new System.Drawing.Point(251, 60);
			this.textBox3.Multiline = true;
			this.textBox3.Name = "textBox3";
			this.textBox3.Size = new System.Drawing.Size(211, 146);
			...
			this.label5.Text = "Хронические заболевания";
			// 
			// comboBox2
			// 
			...
			this.comboBox2.Location = new System.Drawing.Point(32, 182);
			...
			this.label4.Text = "Группа здоровья";
			// 
			// textBox2
			// 
			...
			this.Name = "Red_med_cart";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Редактировать";
			this.Load += new System.EventHandler(this.Red_med_cart_Load);
